...
* 3.Turbo C 是什么？
     - 解答：[参考下面的集成开发环境和编译环境的说明。](#10.集成开发环境和编译环境)&lt;-这是个文档内链接的例子
     - 参考：
...
## 1.关于C语言标准（C Standard）：
   ...
   * 其他参考
      ...
      - [Where do I find the current C or C++ standard documents?](https://stackoverflow.com/questions/81656/where-do-i-find-the-current-c-or-c-standard-documents) - 各标准文档资源<br>
## 2.关于头文件：
